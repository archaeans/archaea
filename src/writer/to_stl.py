...
triangle_floor_1 = Triangle3d([p1, p3, p2, p1])
triangle_floor_2 = Triangle3d([p1, p4, p3, p1])

triangle_ceiling_1 = Triangle3d([p5, p6, p7, p5])
triangle_ceiling_2 = Triangle3d([p5, p7, p8, p5])

triangle_left_1 = Triangle3d([p1, p8, p4, p1])
triangle_left_2 = Triangle3d([p1, p5, p8, p1])

triangle_right_1 = Triangle3d([p2, p3, p7, p2])
triangle_right_2 = Triangle3d([p2, p7, p6, p2])

triangle_front_1 = Triangle3d([p1, p6, p5, p1])
triangle_front_2 = Triangle3d([p1, p2, p6, p1])

triangle_back_1 = Triangle3d([p4, p8, p7, p4])
triangle_back_2 = Triangle3d([p4, p7, p3, p4])


def border_to_stl(file: TextIO, border: Border3d):
...
def to_stl(solid_name: str, borders: "list[Border3d]", export_name: str, path: str = None):
